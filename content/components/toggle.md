...
:::demo toggle/basic
The button carries `tc-pressed` while it is on, and `aria-pressed` alongside it.
:::
...
:::demo toggle/switch
Same component, different CSS. The knob slides because the theme styles `[tc-pressed]`.
:::
