...
:::demo tabs/horizontal
:::

### Vertical

:::demo tabs/vertical
Only the orientation changes: `horizontal={false}` swaps which arrow keys navigate, and `aria-orientation` follows.
:::
