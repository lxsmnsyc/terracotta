...
export type ToolbarProps<T extends ValidConstructor = 'div'> = HeadlessPropsWithRef<
  T,
  { horizontal?: boolean }
>;
 ...
 */
export function Toolbar<T extends ValidConstructor = 'div'>(props: ToolbarProps<T>): JSX.Element {
