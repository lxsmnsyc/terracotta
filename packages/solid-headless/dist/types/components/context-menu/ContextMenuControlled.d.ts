...
export declare type ContextMenuControlledBaseProps = ContextMenuBaseProps & HeadlessDisclosureControlledOptions;
export declare type ContextMenuControlledProps<T extends ValidConstructor = 'div'> = HeadlessProps<T, ContextMenuControlledBaseProps>;
