...
declare type SelectSingleUncontrolledBaseProps<V> = SelectBaseProps & HeadlessSelectSingleUncontrolledOptions<V> & HeadlessSelectRootChildren<V>;
export declare type SelectSingleUncontrolledProps<V, T extends ValidConstructor = 'ul'> = HeadlessPropsWithRef<T, SelectSingleUncontrolledBaseProps<V>>;
