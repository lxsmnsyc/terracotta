...
declare type DialogControlledBaseProps = DialogBaseProps & HeadlessDisclosureControlledOptions;
export declare type DialogControlledProps<T extends ValidConstructor = 'div'> = HeadlessProps<T, DialogControlledBaseProps>;
