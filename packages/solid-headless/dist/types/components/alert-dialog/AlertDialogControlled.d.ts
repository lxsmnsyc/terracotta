...
export declare type AlertDialogControlledBaseProps = AlertDialogBaseProps & HeadlessDisclosureControlledOptions;
export declare type AlertDialogControlledProps<T extends ValidConstructor = 'div'> = HeadlessProps<T, AlertDialogControlledBaseProps>;
