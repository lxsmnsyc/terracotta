...
declare type ListboxSUSCDBaseProps<V> = ListboxBaseProps & ListboxSingleBaseProps<V> & Omit<HeadlessSelectSingleUncontrolledOptions<V>, 'onChange'> & Omit<HeadlessDisclosureControlledOptions, 'onChange'> & {
    children?: JSX.Element;
};
export declare type ListboxSUSCDProps<V, T extends ValidConstructor = typeof Fragment> = HeadlessProps<T, ListboxSUSCDBaseProps<V>>;
