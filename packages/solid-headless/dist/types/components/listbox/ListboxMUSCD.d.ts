...
declare type ListboxMUSCDBaseProps<V> = ListboxBaseProps & ListboxMultipleBaseProps<V> & Omit<HeadlessSelectMultipleUncontrolledOptions<V>, 'onChange'> & Omit<HeadlessDisclosureControlledOptions, 'onChange'> & {
    children?: JSX.Element;
};
export declare type ListboxMUSCDProps<V, T extends ValidConstructor = typeof Fragment> = HeadlessProps<T, ListboxMUSCDBaseProps<V>>;
