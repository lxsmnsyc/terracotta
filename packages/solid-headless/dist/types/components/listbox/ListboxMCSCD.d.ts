...
declare type ListboxMCSCDBaseProps<V> = ListboxBaseProps & ListboxMultipleBaseProps<V> & Omit<HeadlessSelectMultipleControlledOptions<V>, 'onChange'> & Omit<HeadlessDisclosureControlledOptions, 'onChange'> & {
    children?: JSX.Element;
};
export declare type ListboxMCSCDProps<V, T extends ValidConstructor = typeof Fragment> = HeadlessProps<T, ListboxMCSCDBaseProps<V>>;
