...
export declare type RadioGroupUncontrolledProps<V, T extends ValidConstructor = 'div'> = HeadlessPropsWithRef<T, HeadlessSelectSingleUncontrolledOptions<V> & HeadlessSelectRootChildren<V>>;
