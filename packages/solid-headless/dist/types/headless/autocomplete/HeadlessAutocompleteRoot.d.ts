...
export declare type HeadlessAutocompleteRootRenderProp = ((properties: HeadlessAutocompleteProperties) => JSX.Element);
export interface HeadlessAutocompleteRootChildren {
    children?: JSX.Element | HeadlessAutocompleteRootRenderProp;
}
export declare type HeadlessAutocompleteRootProps = HeadlessAutocompleteRootChildren & HeadlessAutocompleteOptions;
