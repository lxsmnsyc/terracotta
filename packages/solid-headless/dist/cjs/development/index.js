...
// src/components/accordion/AccordionContext.ts
var AccordionContext = (0, import_solid_js17.createContext)();
function useAccordionContext(componentName) {
  const context = (0, import_solid_js17.useContext)(AccordionContext);
  if (context) {
    return context;
  }
...
function createAccordionFocusNavigator() {
  return new FocusNavigator((0, import_solid_js17.createUniqueId)());
}
...
function AccordionMultipleControlled(props) {
  ...
  return (0, import_solid_js18.createComponent)(AccordionContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js18.mergeProps)((0, import_solid_use.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "onChange",
...
function AccordionMultipleUncontrolled(props) {
  const controller = createAccordionFocusNavigator();
  return (0, import_solid_js19.createComponent)(AccordionContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js19.mergeProps)((0, import_solid_use2.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "onChange",
...
function AccordionSingleControlled(props) {
  const controller = createAccordionFocusNavigator();
  return (0, import_solid_js20.createComponent)(AccordionContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js20.mergeProps)((0, import_solid_use3.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "onChange",
...
function AccordionSingleUncontrolled(props) {
  const controller = createAccordionFocusNavigator();
  return (0, import_solid_js21.createComponent)(AccordionContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js21.mergeProps)((0, import_solid_use4.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "onChange",
...
function Accordion(props) {
  if (isAccordionUncontrolled(props)) {
    if (isAccordionMultiple(props)) {
      return (0, import_solid_js22.createComponent)(AccordionMultipleUncontrolled, props);
    }
    return (0, import_solid_js22.createComponent)(AccordionSingleUncontrolled, props);
  }
  if (isAccordionMultiple(props)) {
    return (0, import_solid_js22.createComponent)(AccordionMultipleControlled, props);
  }
  return (0, import_solid_js22.createComponent)(AccordionSingleControlled, props);
}
...
var AccordionItemContext = (0, import_solid_js23.createContext)();
function useAccordionItemContext(componentName) {
  const context = (0, import_solid_js23.useContext)(AccordionItemContext);
  if (context) {
    return context;
  }
...
function AccordionItem(props) {
  ...
  const buttonID = (0, import_solid_js24.createUniqueId)();
  const panelID = (0, import_solid_js24.createUniqueId)();
  return (0, import_solid_js24.createComponent)(AccordionItemContext.Provider, {
    value: { buttonID, panelID },
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js24.mergeProps)((0, import_solid_use5.omitProps)(props, [
        "as",
        "children",
        "value",
        "disabled"
...
function AccordionHeader(props) {
  ...
  }, (0, import_solid_js25.mergeProps)((0, import_solid_use6.omitProps)(props, [
    "as",
    "children"
...
function Button(props) {
  const [internalRef, setInternalRef] = (0, import_solid_js26.createSignal)();
  ...
  }, (0, import_solid_js26.mergeProps)({
    get tabindex() {
      return props.disabled ? -1 : 0;
    },
    role: "button"
  }, createDisabled(() => props.disabled), (0, import_solid_use7.omitProps)(props, [
    "as",
    "ref"
  ]), BUTTON_TAG, {
    ref: createRef(props, (e) => {
...
function AccordionButton(props) {
  ...
  const properties = useHeadlessSelectOptionProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js27.createSignal)();
  ...
  return (0, import_solid_js27.createComponent)(Button, (0, import_solid_js27.mergeProps)((0, import_solid_use8.omitProps)(props, ["children", "ref", "disabled"]), ACCORDION_BUTTON_TAG, {
...
function createUnmountable(props, shouldMount, render) {
  return (0, import_solid_js28.createComponent)(import_solid_js28.Show, {
    get when() {
      var _a;
...
function AccordionPanel(props) {
  ...
  return createUnmountable(props, () => properties.isSelected(), () => createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js29.mergeProps)((0, import_solid_use9.omitProps)(props, [
    "as",
    "children",
    "unmount"
  ]), {
...
function Alert(props) {
  const alertID = (0, import_solid_js30.createUniqueId)();
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js30.mergeProps)({
    id: alertID
  }, (0, import_solid_use10.omitProps)(props, ["as"]), ALERT_TAG, {
    role: "alert"
  }));
}
...
var AlertDialogContext = (0, import_solid_js32.createContext)();
function useAlertDialogContext(componentName) {
  const context = (0, import_solid_js32.useContext)(AlertDialogContext);
  if (context) {
    return context;
  }
...
function AlertDialogControlled(props) {
  const ownerID = (0, import_solid_js33.createUniqueId)();
  const panelID = (0, import_solid_js33.createUniqueId)();
  const titleID = (0, import_solid_js33.createUniqueId)();
  const descriptionID = (0, import_solid_js33.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js33.createComponent)(AlertDialogContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return (0, import_solid_js33.createComponent)(HeadlessDisclosureRoot, {
        get isOpen() {
          return props.isOpen;
        },
        get disabled() {
        ...
        children: ({ isOpen }) => createUnmountable(props, isOpen, () => createDynamic(() => {
          var _a;
          return (_a = props.as) != null ? _a : "div";
        }, (0, import_solid_js33.mergeProps)((0, import_solid_use11.omitProps)(props, [
          "as",
          "children",
          "unmount",
          "isOpen",
...
function AlertDialogUncontrolled(props) {
  const ownerID = (0, import_solid_js34.createUniqueId)();
  const panelID = (0, import_solid_js34.createUniqueId)();
  const titleID = (0, import_solid_js34.createUniqueId)();
  const descriptionID = (0, import_solid_js34.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js34.createComponent)(AlertDialogContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return (0, import_solid_js34.createComponent)(HeadlessDisclosureRoot, {
        get defaultOpen() {
        ...
        children: ({ isOpen }) => createUnmountable(props, isOpen, () => createDynamic(() => {
          var _a;
          return (_a = props.as) != null ? _a : "div";
        }, (0, import_solid_js34.mergeProps)((0, import_solid_use12.omitProps)(props, [
          "as",
          "children",
          "unmount",
          "defaultOpen",
...
function AlertDialog(props) {
  if (isAlertDialogUncontrolled(props)) {
    return (0, import_solid_js35.createComponent)(AlertDialogUncontrolled, props);
  }
  return (0, import_solid_js35.createComponent)(AlertDialogControlled, props);
}
...
function AlertDialogDescription(props) {
  ...
  }, (0, import_solid_js36.mergeProps)((0, import_solid_use13.omitProps)(props, [
    "as",
    "children"
...
function AlertDialogOverlay(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js37.mergeProps)((0, import_solid_use14.omitProps)(props, [
    "as",
    "children",
    "ref"
...
function AlertDialogPanel(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js38.createSignal)();
  (0, import_solid_js38.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js38.mergeProps)((0, import_solid_use15.omitProps)(props, [
    "as",
    "children",
    "ref"
  ]), ALERT_DIALOG_PANEL, {
...
function AlertDialogTitle(props) {
  ...
  }, (0, import_solid_js39.mergeProps)((0, import_solid_use16.omitProps)(props, [
    "as",
    "children"
  ]), ALERT_DIALOG_TITLE, {
    id: context.titleID
...
function Fragment(props) {
  return (0, import_solid_js40.createMemo)(() => props.children);
}

// src/components/checkbox/CheckboxContext.ts
var import_solid_js41 = require("solid-js");
var CheckboxContext = (0, import_solid_js41.createContext)();
function useCheckboxContext(componentName) {
  const context = (0, import_solid_js41.useContext)(CheckboxContext);
  if (context) {
    return context;
  }
...
function CheckboxControlled(props) {
  const ownerID = (0, import_solid_js42.createUniqueId)();
  const labelID = (0, import_solid_js42.createUniqueId)();
  const indicatorID = (0, import_solid_js42.createUniqueId)();
  const descriptionID = (0, import_solid_js42.createUniqueId)();
  return (0, import_solid_js42.createComponent)(CheckboxContext.Provider, {
    value: {
      ownerID,
      labelID,
      indicatorID,
    ...
    get children() {
      return createDynamic(() => {
      ...
      }, (0, import_solid_js42.mergeProps)((0, import_solid_use17.omitProps)(props, [
        "checked",
        "as",
        "children",
        "disabled",
        ...
        get children() {
          return (0, import_solid_js42.createComponent)(HeadlessToggleRoot, {
            onChange: props.onChange,
            get checked() {
...
function CheckboxUncontrolled(props) {
  ...
  const labelID = (0, import_solid_js43.createUniqueId)();
  const indicatorID = (0, import_solid_js43.createUniqueId)();
  const descriptionID = (0, import_solid_js43.createUniqueId)();
  return (0, import_solid_js43.createComponent)(CheckboxContext.Provider, {
    value: {
      ownerID,
      labelID,
      indicatorID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js43.mergeProps)((0, import_solid_use18.omitProps)(props, [
        "defaultChecked",
        "as",
        "children",
        "disabled",
        ...
        get children() {
          return (0, import_solid_js43.createComponent)(HeadlessToggleRoot, {
            onChange: props.onChange,
            get checked() {
              return props.checked;
            },
...
function Checkbox(props) {
  if (isCheckboxUncontrolled(props)) {
    return (0, import_solid_js44.createComponent)(CheckboxUncontrolled, props);
  }
  return (0, import_solid_js44.createComponent)(CheckboxControlled, props);
}
...
function CheckboxDescription(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "p";
  }, (0, import_solid_js45.mergeProps)((0, import_solid_use19.omitProps)(props, [
    "as",
    "children"
...
function CheckboxIndicator(props) {
  ...
  const [internalRef, setInternalRef] = (0, import_solid_js46.createSignal)();
  ...
  return (0, import_solid_js46.createComponent)(Button, (0, import_solid_js46.mergeProps)((0, import_solid_use20.omitProps)(props, [
    "children",
    "ref"
  ]), CHECKBOX_INDICATOR, {
    ...
    get children() {
      return (0, import_solid_js46.createComponent)(HeadlessToggleChild, {
        get children() {
          return props.children;
        }
      });
...
function CheckboxLabel(props) {
  ...
  }, (0, import_solid_js47.mergeProps)((0, import_solid_use21.omitProps)(props, [
    "as",
    "children"
  ]), CHECKBOX_LABEL, {
    id: context.labelID,
...
var ColorSchemeContext = (0, import_solid_js48.createContext)();
var STORAGE_KEY = "theme-preference";
function ColorSchemeProvider(props) {
  let get;
  let set;
  if ("initialValue" in props) {
    const [scheme, setScheme] = (0, import_solid_js48.createSignal)(props.initialValue);
    get = scheme;
    set = (value) => {
      var _a;
      setScheme(value);
  ...
  const shouldToggle = (0, import_solid_js48.createMemo)(() => get() === "system" && prefersDark() || get() === "dark");
  ...
  return (0, import_solid_js48.createComponent)(ColorSchemeContext.Provider, {
    value: {
      get value() {
        return get();
      },
...
function useColorSchemeContext() {
  const ctx = (0, import_solid_js48.useContext)(ColorSchemeContext);
  if (ctx) {
    return ctx;
  }
...
var CommandBarContext = (0, import_solid_js49.createContext)();
function useCommandBarContext(componentName) {
  const context = (0, import_solid_js49.useContext)(CommandBarContext);
  if (context) {
    return context;
  }
...
function CommandBarControlled(props) {
  const ownerID = (0, import_solid_js51.createUniqueId)();
  const panelID = (0, import_solid_js51.createUniqueId)();
  const titleID = (0, import_solid_js51.createUniqueId)();
  const descriptionID = (0, import_solid_js51.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js51.createComponent)(CommandBarContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return (0, import_solid_js51.createComponent)(HeadlessDisclosureRoot, {
        get isOpen() {
          return props.isOpen;
        },
        get disabled() {
        ...
        children: ({ isOpen }) => (0, import_solid_js51.createComponent)(CommandBarEvents, {
          get children() {
            return createUnmountable(props, isOpen, () => createDynamic(() => {
              var _a;
              return (_a = props.as) != null ? _a : "div";
            }, (0, import_solid_js51.mergeProps)((0, import_solid_use23.omitProps)(props, [
              "as",
              "children",
              "unmount",
              "isOpen",
...
function CommandBarUncontrolled(props) {
  ...
  const panelID = (0, import_solid_js52.createUniqueId)();
  const titleID = (0, import_solid_js52.createUniqueId)();
  const descriptionID = (0, import_solid_js52.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js52.createComponent)(CommandBarContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return (0, import_solid_js52.createComponent)(HeadlessDisclosureRoot, {
        get defaultOpen() {
          return props.defaultOpen;
        },
        get disabled() {
        ...
        children: ({ isOpen }) => (0, import_solid_js52.createComponent)(CommandBarEvents, {
          get children() {
            return createUnmountable(props, isOpen, () => createDynamic(() => {
              var _a;
              return (_a = props.as) != null ? _a : "div";
            }, (0, import_solid_js52.mergeProps)((0, import_solid_use24.omitProps)(props, [
              "as",
              "children",
              "unmount",
              "defaultOpen",
...
function CommandBar(props) {
  if (isCommandBarUncontrolled(props)) {
    return (0, import_solid_js53.createComponent)(CommandBarUncontrolled, props);
  }
  return (0, import_solid_js53.createComponent)(CommandBarControlled, props);
}
...
function CommandBarDescription(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "p";
  }, (0, import_solid_js54.mergeProps)((0, import_solid_use25.omitProps)(props, [
    "as",
    "children"
...
function CommandBarOverlay(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js55.createSignal)();
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js55.mergeProps)((0, import_solid_use26.omitProps)(props, [
    "as",
    "children",
    "ref"
...
function CommandBarPanel(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js56.mergeProps)((0, import_solid_use27.omitProps)(props, [
    "as",
    "children",
    "ref"
...
function CommandBarTitle(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "h2";
  }, (0, import_solid_js57.mergeProps)((0, import_solid_use28.omitProps)(props, [
    "as",
    "children"
...
var ContextMenuContext = (0, import_solid_js58.createContext)();
function useContextMenuContext(componentName) {
  const context = (0, import_solid_js58.useContext)(ContextMenuContext);
  if (context) {
    return context;
  }
...
function ContextMenuControlled(props) {
  ...
  const boundaryID = (0, import_solid_js59.createUniqueId)();
  const panelID = (0, import_solid_js59.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js59.createComponent)(ContextMenuContext.Provider, {
    value: {
      ownerID,
      boundaryID,
      panelID
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js59.mergeProps)((0, import_solid_use29.omitProps)(props, [
        "isOpen",
        "as",
        "children",
        "disabled",
        ...
        get children() {
          return (0, import_solid_js59.createComponent)(HeadlessDisclosureRoot, {
            get isOpen() {
              return props.isOpen;
            },
            get disabled() {
...
function ContextMenuUncontrolled(props) {
  const ownerID = (0, import_solid_js60.createUniqueId)();
  const boundaryID = (0, import_solid_js60.createUniqueId)();
  const panelID = (0, import_solid_js60.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js60.createComponent)(ContextMenuContext.Provider, {
    value: {
      ownerID,
      boundaryID,
      panelID
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js60.mergeProps)((0, import_solid_use30.omitProps)(props, [
        "defaultOpen",
        "as",
        "children",
        "disabled",
        ...
        get children() {
          return (0, import_solid_js60.createComponent)(HeadlessDisclosureRoot, {
            get defaultOpen() {
              return props.defaultOpen;
            },
            get disabled() {
...
function ContextMenu(props) {
  if (isContextMenuUncontrolled(props)) {
    return (0, import_solid_js61.createComponent)(ContextMenuUncontrolled, props);
  }
  return (0, import_solid_js61.createComponent)(ContextMenuControlled, props);
}
...
function ContextMenuBoundary(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js62.createSignal)();
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js62.mergeProps)((0, import_solid_use31.omitProps)(props, [
    "as",
    "children",
    "ref"
...
function ContextMenuOverlay(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js63.createSignal)();
  (0, import_solid_js63.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const onClick = () => {
        properties.setState(false);
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js63.mergeProps)((0, import_solid_use32.omitProps)(props, [
    "as",
    "children",
    "ref"
...
function ContextMenuPanel(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js64.createSignal)();
  (0, import_solid_js64.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      if (properties.isOpen()) {
        focusFirst(getFocusableElements(ref));
  ...
  return createUnmountable(props, () => properties.isOpen(), () => createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js64.mergeProps)((0, import_solid_use33.omitProps)(props, [
    "as",
    "unmount",
    "children",
    "ref"
...
var DialogContext = (0, import_solid_js65.createContext)();
function useDialogContext(componentName) {
  const context = (0, import_solid_js65.useContext)(DialogContext);
  if (context) {
    return context;
  }
...
function DialogControlled(props) {
  const ownerID = (0, import_solid_js66.createUniqueId)();
  const panelID = (0, import_solid_js66.createUniqueId)();
  const titleID = (0, import_solid_js66.createUniqueId)();
  const descriptionID = (0, import_solid_js66.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js66.createComponent)(DialogContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return (0, import_solid_js66.createComponent)(HeadlessDisclosureRoot, {
        get isOpen() {
          return props.isOpen;
        },
        get disabled() {
        ...
        children: ({ isOpen }) => createUnmountable(props, isOpen, () => createDynamic(() => {
          var _a;
          return (_a = props.as) != null ? _a : "div";
        }, (0, import_solid_js66.mergeProps)((0, import_solid_use34.omitProps)(props, [
          "as",
          "children",
          "unmount",
          "isOpen",
...
function DialogUncontrolled(props) {
  const ownerID = (0, import_solid_js67.createUniqueId)();
  const panelID = (0, import_solid_js67.createUniqueId)();
  const titleID = (0, import_solid_js67.createUniqueId)();
  const descriptionID = (0, import_solid_js67.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js67.createComponent)(DialogContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return (0, import_solid_js67.createComponent)(HeadlessDisclosureRoot, {
        get defaultOpen() {
          return props.defaultOpen;
        },
        get disabled() {
        ...
        children: ({ isOpen }) => createUnmountable(props, isOpen, () => createDynamic(() => {
          var _a;
          return (_a = props.as) != null ? _a : "div";
        }, (0, import_solid_js67.mergeProps)((0, import_solid_use35.omitProps)(props, [
          "as",
          "children",
          "unmount",
          "defaultOpen",
...
function Dialog(props) {
  if (isDialogUncontrolled(props)) {
    return (0, import_solid_js68.createComponent)(DialogUncontrolled, props);
  }
  return (0, import_solid_js68.createComponent)(DialogControlled, props);
}
...
function DialogDescription(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "p";
  }, (0, import_solid_js69.mergeProps)((0, import_solid_use36.omitProps)(props, [
    "as",
    "children"
...
function DialogOverlay(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js70.createSignal)();
  (0, import_solid_js70.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const onClick = () => {
        properties.setState(false);
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js70.mergeProps)((0, import_solid_use37.omitProps)(props, [
    "as",
    "children",
    "ref"
  ]), DIALOG_OVERLAY_TAG, {
...
function DialogPanel(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js71.createSignal)();
  (0, import_solid_js71.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      if (properties.isOpen()) {
        focusFirst(getFocusableElements(ref));
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js71.mergeProps)((0, import_solid_use38.omitProps)(props, [
    "as",
    "children",
    "ref"
  ]), DIALOG_PANEL_TAG, {
...
function DialogTitle(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "h2";
  }, (0, import_solid_js72.mergeProps)((0, import_solid_use39.omitProps)(props, [
    "as",
    "children"
  ]), DIALOG_TITLE_TAG, {
    id: context.titleID
...
var DisclosureContext = (0, import_solid_js73.createContext)();
function useDisclosureContext(componentName) {
  const context = (0, import_solid_js73.useContext)(DisclosureContext);
  if (context) {
    return context;
  }
...
function DisclosureControlled(props) {
  const ownerID = (0, import_solid_js74.createUniqueId)();
  const buttonID = (0, import_solid_js74.createUniqueId)();
  const panelID = (0, import_solid_js74.createUniqueId)();
  return (0, import_solid_js74.createComponent)(DisclosureContext.Provider, {
    value: {
      ownerID,
      buttonID,
      panelID
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js74.mergeProps)((0, import_solid_use40.omitProps)(props, [
        "isOpen",
        "as",
        "children",
        "disabled",
        ...
        get children() {
          return (0, import_solid_js74.createComponent)(HeadlessDisclosureRoot, {
            get isOpen() {
              return props.isOpen;
            },
            get disabled() {
...
function DisclosureUncontrolled(props) {
  const ownerID = (0, import_solid_js75.createUniqueId)();
  const buttonID = (0, import_solid_js75.createUniqueId)();
  const panelID = (0, import_solid_js75.createUniqueId)();
  return (0, import_solid_js75.createComponent)(DisclosureContext.Provider, {
    value: {
      ownerID,
      buttonID,
      panelID
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js75.mergeProps)((0, import_solid_use41.omitProps)(props, [
        "defaultOpen",
        "as",
        "children",
        "disabled",
        ...
        get children() {
          return (0, import_solid_js75.createComponent)(HeadlessDisclosureRoot, {
            get defaultOpen() {
              return props.defaultOpen;
            },
            get disabled() {
...
function Disclosure(props) {
  if (isDisclosureUncontrolled(props)) {
    return (0, import_solid_js76.createComponent)(DisclosureUncontrolled, props);
  }
  return (0, import_solid_js76.createComponent)(DisclosureControlled, props);
}
...
function DisclosureButton(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js77.createSignal)();
  (0, import_solid_js77.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const toggle = () => {
        if (!(properties.disabled() || props.disabled)) {
      ...
      ref.addEventListener("click", toggle);
      (0, import_solid_js77.onCleanup)(() => {
        ref.removeEventListener("click", toggle);
      });
    }
  });
  return (0, import_web2.createComponent)(Button, (0, import_solid_js77.mergeProps)((0, import_solid_use42.omitProps)(props, [
    "children",
    "ref"
...
function DisclosurePanel(props) {
  ...
  return createUnmountable(props, () => properties.isOpen(), () => createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js78.mergeProps)((0, import_solid_use43.omitProps)(props, [
    "as",
    "unmount",
    "children"
...
var FeedContext = (0, import_solid_js79.createContext)();
function useFeedContext(componentName) {
  const context = (0, import_solid_js79.useContext)(FeedContext);
  if (context) {
    return context;
  }
...
// src/components/feed/Feed.ts
function Feed(props) {
  const ownerID = (0, import_solid_js80.createUniqueId)();
  const labelID = (0, import_solid_js80.createUniqueId)();
  const contentID = (0, import_solid_js80.createUniqueId)();
  let internalRef;
  return (0, import_solid_js80.createComponent)(FeedContext.Provider, {
    value: {
      ownerID,
      labelID,
      contentID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js80.mergeProps)((0, import_solid_use44.omitProps)(props, [
        "as",
        "busy",
        "size"
      ]), FEED_TAG, {
...
var FeedArticleContext = (0, import_solid_js81.createContext)();
function useFeedArticleContext(componentName) {
  const context = (0, import_solid_js81.useContext)(FeedArticleContext);
  if (context) {
    return context;
  }
...
var FeedContentContext = (0, import_solid_js82.createContext)();
function useFeedContentContext(componentName) {
  const context = (0, import_solid_js82.useContext)(FeedContentContext);
  if (context) {
    return context;
  }
...
function FeedArticle(props) {
  ...
  const [internalRef, setInternalRef] = (0, import_solid_js83.createSignal)();
  (0, import_solid_js83.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const onKeyDown = (e) => {
        switch (e.key) {
  ...
  const ownerID = (0, import_solid_js83.createUniqueId)();
  const labelID = (0, import_solid_js83.createUniqueId)();
  const descriptionID = (0, import_solid_js83.createUniqueId)();
  return (0, import_solid_js83.createComponent)(FeedArticleContext.Provider, {
    value: {
      ownerID,
      labelID,
      descriptionID
    ...
    get children() {
      ...
      }, (0, import_solid_js83.mergeProps)((0, import_solid_use45.omitProps)(props, ["as"]), FEED_ARTICLE_TAG, createOwnerAttribute(rootContext.ownerID), {
        id: ownerID,
...
function FeedArticleDescription(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "p";
  }, (0, import_solid_js84.mergeProps)((0, import_solid_use46.omitProps)(props, ["as"]), FEED_ARTICLE_DESCRIPTION_TAG, {
    id: context.descriptionID
  }));
}
...
function FeedArticleLabel(props) {
  ...
  }, (0, import_solid_js85.mergeProps)((0, import_solid_use47.omitProps)(props, ["as"]), FEED_ARTICLE_LABEL_TAG, {
    id: context.labelID
  }));
}
...
function FeedContent(props) {
  ...
  const [internalRef, setInternalRef] = (0, import_solid_js86.createSignal)();
  ...
  return (0, import_solid_js86.createComponent)(FeedContentContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js86.mergeProps)((0, import_solid_use48.omitProps)(props, ["as"]), FEED_CONTENT_TAG, {
...
function FeedLabel(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "span";
  }, (0, import_solid_js87.mergeProps)((0, import_solid_use49.omitProps)(props, ["as"]), FEED_LABEL_TAG, {
    id: context.labelID
  }));
}
...
var ListboxContext = (0, import_solid_js88.createContext)();
function useListboxContext(componentName) {
  const context = (0, import_solid_js88.useContext)(ListboxContext);
  if (context) {
    return context;
  }
...
function ListboxMCSCD(props) {
  const [hovering, setHovering] = (0, import_solid_js89.createSignal)(false);
  const ownerID = (0, import_solid_js89.createUniqueId)();
  const labelID = (0, import_solid_js89.createUniqueId)();
  const buttonID = (0, import_solid_js89.createUniqueId)();
  const optionsID = (0, import_solid_js89.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js89.createComponent)(ListboxContext.Provider, {
    value: {
      multiple: true,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js89.mergeProps)((0, import_solid_use50.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "horizontal",
        ...
        get children() {
          return (0, import_solid_js89.createComponent)(HeadlessSelectRoot, {
            multiple: true,
            ...
            get children() {
              return (0, import_solid_js89.createComponent)(HeadlessDisclosureRoot, {
                onChange(value) {
                  var _a;
                  if (value) {
                    fsp.save();
...
function ListboxMCSUD(props) {
  const [hovering, setHovering] = (0, import_solid_js90.createSignal)(false);
  ...
  const optionsID = (0, import_solid_js90.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js90.createComponent)(ListboxContext.Provider, {
    value: {
      multiple: true,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js90.mergeProps)((0, import_solid_use51.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "horizontal",
        ...
        get children() {
          return (0, import_solid_js90.createComponent)(HeadlessSelectRoot, {
            multiple: true,
            onChange: props.onSelectChange,
            get toggleable() {
              return props.toggleable;
            ...
            get children() {
              return (0, import_solid_js90.createComponent)(HeadlessDisclosureRoot, {
                onChange(value) {
                  var _a;
                  if (value) {
                    fsp.save();
...
function ListboxMUSCD(props) {
  const [hovering, setHovering] = (0, import_solid_js91.createSignal)(false);
  const ownerID = (0, import_solid_js91.createUniqueId)();
  const labelID = (0, import_solid_js91.createUniqueId)();
  const buttonID = (0, import_solid_js91.createUniqueId)();
  const optionsID = (0, import_solid_js91.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js91.createComponent)(ListboxContext.Provider, {
    value: {
      multiple: true,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js91.mergeProps)((0, import_solid_use52.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "horizontal",
        ...
        get children() {
          return (0, import_solid_js91.createComponent)(HeadlessSelectRoot, {
            multiple: true,
            onChange: props.onSelectChange,
            get toggleable() {
              return props.toggleable;
            ...
            get children() {
              return (0, import_solid_js91.createComponent)(HeadlessDisclosureRoot, {
                onChange(value) {
                  var _a;
                  if (value) {
                    fsp.save();
...
function ListboxMUSUD(props) {
  const [hovering, setHovering] = (0, import_solid_js92.createSignal)(false);
  const ownerID = (0, import_solid_js92.createUniqueId)();
  const labelID = (0, import_solid_js92.createUniqueId)();
  const buttonID = (0, import_solid_js92.createUniqueId)();
  const optionsID = (0, import_solid_js92.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js92.createComponent)(ListboxContext.Provider, {
    value: {
      multiple: true,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js92.mergeProps)((0, import_solid_use53.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "horizontal",
        ...
        get children() {
          return (0, import_solid_js92.createComponent)(HeadlessSelectRoot, {
            multiple: true,
            onChange: props.onSelectChange,
            get toggleable() {
              return props.toggleable;
            ...
            get children() {
              return (0, import_solid_js92.createComponent)(HeadlessDisclosureRoot, {
                onChange(value) {
                  var _a;
                  if (value) {
                    fsp.save();
...
function ListboxSCSCD(props) {
  const [hovering, setHovering] = (0, import_solid_js93.createSignal)(false);
  const ownerID = (0, import_solid_js93.createUniqueId)();
  const labelID = (0, import_solid_js93.createUniqueId)();
  const buttonID = (0, import_solid_js93.createUniqueId)();
  const optionsID = (0, import_solid_js93.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js93.createComponent)(ListboxContext.Provider, {
    value: {
      multiple: false,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js93.mergeProps)((0, import_solid_use54.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "horizontal",
        ...
        get children() {
          return (0, import_solid_js93.createComponent)(HeadlessSelectRoot, {
            onChange: props.onSelectChange,
            get toggleable() {
              return props.toggleable;
            },
            ...
            get children() {
              return (0, import_solid_js93.createComponent)(HeadlessDisclosureRoot, {
                onChange(value) {
                  var _a;
                  if (value) {
                    fsp.save();
...
function ListboxSCSUD(props) {
  const [hovering, setHovering] = (0, import_solid_js94.createSignal)(false);
  const ownerID = (0, import_solid_js94.createUniqueId)();
  const labelID = (0, import_solid_js94.createUniqueId)();
  const buttonID = (0, import_solid_js94.createUniqueId)();
  const optionsID = (0, import_solid_js94.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js94.createComponent)(ListboxContext.Provider, {
    value: {
      multiple: false,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js94.mergeProps)((0, import_solid_use55.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "horizontal",
        ...
        get children() {
          return (0, import_solid_js94.createComponent)(HeadlessSelectRoot, {
            onChange: props.onSelectChange,
            get toggleable() {
              return props.toggleable;
            },
            ...
            get children() {
              return (0, import_solid_js94.createComponent)(HeadlessDisclosureRoot, {
                onChange(value) {
                  var _a;
                  if (value) {
                    fsp.save();
...
function ListboxSUSCD(props) {
  const [hovering, setHovering] = (0, import_solid_js95.createSignal)(false);
  const ownerID = (0, import_solid_js95.createUniqueId)();
  const labelID = (0, import_solid_js95.createUniqueId)();
  const buttonID = (0, import_solid_js95.createUniqueId)();
  const optionsID = (0, import_solid_js95.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js95.createComponent)(ListboxContext.Provider, {
    value: {
      multiple: false,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js95.mergeProps)((0, import_solid_use56.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "horizontal",
        ...
        get children() {
          return (0, import_solid_js95.createComponent)(HeadlessSelectRoot, {
            onChange: props.onSelectChange,
            get toggleable() {
              return props.toggleable;
            },
            ...
            get children() {
              return (0, import_solid_js95.createComponent)(HeadlessDisclosureRoot, {
                onChange(value) {
                  var _a;
                  if (value) {
                    fsp.save();
...
function ListboxSUSUD(props) {
  const [hovering, setHovering] = (0, import_solid_js96.createSignal)(false);
  const ownerID = (0, import_solid_js96.createUniqueId)();
  const labelID = (0, import_solid_js96.createUniqueId)();
  const buttonID = (0, import_solid_js96.createUniqueId)();
  const optionsID = (0, import_solid_js96.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js96.createComponent)(ListboxContext.Provider, {
    value: {
      multiple: false,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : Fragment;
      }, (0, import_solid_js96.mergeProps)((0, import_solid_use57.omitProps)(props, [
        "as",
        "children",
        "disabled",
        "horizontal",
        ...
        get children() {
          return (0, import_solid_js96.createComponent)(HeadlessSelectRoot, {
            onChange: props.onSelectChange,
            get toggleable() {
              return props.toggleable;
            },
            ...
            get children() {
              return (0, import_solid_js96.createComponent)(HeadlessDisclosureRoot, {
                onChange(value) {
                  var _a;
                  if (value) {
                    fsp.save();
  ...
  if (isListboxMultiple(props)) {
    if (isListboxSelectUncontrolled(props)) {
      if (isListboxDisclosureUncontrolled(props)) {
        return (0, import_solid_js97.createComponent)(ListboxMUSUD, props);
      }
      return (0, import_solid_js97.createComponent)(ListboxMUSCD, props);
    }
    if (isListboxDisclosureUncontrolled(props)) {
      return (0, import_solid_js97.createComponent)(ListboxMCSUD, props);
    }
    return (0, import_solid_js97.createComponent)(ListboxMCSCD, props);
  }
  if (isListboxSelectUncontrolled(props)) {
    if (isListboxDisclosureUncontrolled(props)) {
      return (0, import_solid_js97.createComponent)(ListboxSUSUD, props);
    }
    return (0, import_solid_js97.createComponent)(ListboxSUSCD, props);
  }
  if (isListboxDisclosureUncontrolled(props)) {
    return (0, import_solid_js97.createComponent)(ListboxSCSUD, props);
  }
  return (0, import_solid_js97.createComponent)(ListboxSCSCD, props);
}
...
function ListboxButton(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js98.createSignal)();
  (0, import_solid_js98.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const toggle = (e) => {
  ...
  return (0, import_solid_js98.createComponent)(Button, (0, import_solid_js98.mergeProps)((0, import_solid_use58.omitProps)(props, [
    "children",
    "ref"
  ]), LISTBOX_BUTTON_TAG, {
    id: context.buttonID,
...
function ListboxLabel(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "label";
  }, (0, import_solid_js99.mergeProps)((0, import_solid_use59.omitProps)(props, [
    "as",
    "children"
  ]), LISTBOX_LABEL_TAG, {
    id: context.labelID
...
var ListboxOptionsContext = (0, import_solid_js100.createContext)();
function useListboxOptionsContext(componentName) {
  const context = (0, import_solid_js100.useContext)(ListboxOptionsContext);
  if (context) {
    return context;
  }
...
function ListboxOption(props) {
  ...
  const properties = useHeadlessSelectProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js101.createSignal)();
  let characters = "";
  let timeout;
  ...
  (0, import_solid_js101.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      if (disclosure.isOpen() && (0, import_solid_js101.untrack)(() => properties.isSelected(props.value)) && !isDisabled()) {
        ref.focus();
      }
    }
  });
  return (0, import_solid_js101.createComponent)(Button, (0, import_solid_js101.mergeProps)((0, import_solid_use60.omitProps)(props, [
    "as",
    "children",
    "value",
    "ref"
...
function ListboxOptions(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js102.createSignal)();
  ...
  (0, import_solid_js102.createEffect)(() => {
    ...
    if (ref instanceof HTMLElement) {
      ...
      (0, import_solid_js102.onCleanup)(() => {
        ref.removeEventListener("focusout", onBlur);
      });
    }
  });
  return (0, import_solid_js102.createComponent)(ListboxOptionsContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "ul";
      }, (0, import_solid_js102.mergeProps)((0, import_solid_use61.omitProps)(props, [
        "as",
        "children",
        "ref"
      ]), LISTBOX_OPTIONS_TAG, {
...
var MenuContext = (0, import_solid_js103.createContext)();
function useMenuContext(componentName) {
  const context = (0, import_solid_js103.useContext)(MenuContext);
  if (context) {
    return context;
  }
...
function createMenuItemFocusNavigator() {
  return new FocusNavigator((0, import_solid_js103.createUniqueId)());
}
...
function Menu(props) {
  ...
  return (0, import_solid_js104.createComponent)(MenuContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js104.mergeProps)((0, import_solid_use62.omitProps)(props, ["as", "ref"]), MENU_TAG, {
        id: controller.getId(),
        role: "menu",
        ref: createRef(props, (e) => {
          controller.setRef(e);
...
function MenuChild(props) {
  return (0, import_solid_js105.createMemo)(() => {
    const body = props.children;
...
function MenuItem(props) {
  ...
  const [internalRef, setInternalRef] = (0, import_solid_js106.createSignal)();
  let characters = "";
  let timeout;
  (0, import_solid_js106.onCleanup)(() => {
    if (timeout) {
      clearTimeout(timeout);
    }
  });
  (0, import_solid_js106.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const onKeyDown = (e) => {
        if (!props.disabled) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js106.mergeProps)((0, import_solid_use63.omitProps)(props, [
    "as",
    "disabled",
    "ref",
    "children"
    ...
    get children() {
      return (0, import_solid_js106.createComponent)(MenuChild, {
        get disabled() {
          return props.disabled;
        },
        get children() {
...
var PopoverContext = (0, import_solid_js107.createContext)();
function usePopoverContext(componentName) {
  const context = (0, import_solid_js107.useContext)(PopoverContext);
  if (context) {
    return context;
  }
...
function PopoverControlled(props) {
  const [hovering, setHovering] = (0, import_solid_js108.createSignal)(false);
  const ownerID = (0, import_solid_js108.createUniqueId)();
  const buttonID = (0, import_solid_js108.createUniqueId)();
  const panelID = (0, import_solid_js108.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js108.createComponent)(PopoverContext.Provider, {
    value: {
      ownerID,
      buttonID,
      panelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js108.mergeProps)((0, import_solid_use64.omitProps)(props, [
        "isOpen",
        "as",
        "children",
        "disabled",
        ...
        get children() {
          return (0, import_solid_js108.createComponent)(HeadlessDisclosureRoot, {
            get isOpen() {
              return props.isOpen;
            },
            get disabled() {
...
function PopoverUncontrolled(props) {
  const [hovering, setHovering] = (0, import_solid_js109.createSignal)(false);
  const ownerID = (0, import_solid_js109.createUniqueId)();
  const buttonID = (0, import_solid_js109.createUniqueId)();
  const panelID = (0, import_solid_js109.createUniqueId)();
  const fsp = useFocusStartPoint();
  return (0, import_solid_js109.createComponent)(PopoverContext.Provider, {
    value: {
      ownerID,
      buttonID,
      panelID,
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js109.mergeProps)((0, import_solid_use65.omitProps)(props, [
        "defaultOpen",
        "as",
        "children",
        "disabled",
        ...
        get children() {
          return (0, import_solid_js109.createComponent)(HeadlessDisclosureRoot, {
            get defaultOpen() {
              return props.defaultOpen;
            },
            get disabled() {
...
function Popover(props) {
  if (isPopoverUncontrolled(props)) {
    return (0, import_solid_js110.createComponent)(PopoverUncontrolled, props);
  }
  return (0, import_solid_js110.createComponent)(PopoverControlled, props);
}
...
function PopoverButton(props) {
  ...
  return (0, import_solid_js111.createComponent)(Button, (0, import_solid_js111.mergeProps)((0, import_solid_use66.omitProps)(props, [
    "children",
    "ref"
  ]), POPOVER_BUTTON_TAG, {
    id: context.buttonID,
...
function PopoverOverlay(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js112.mergeProps)((0, import_solid_use67.omitProps)(props, [
    "as",
    "children",
    "ref"
  ]), POPOVER_OVERLAY_TAG, {
...
function PopoverPanel(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js113.createSignal)();
  (0, import_solid_js113.createEffect)(() => {
    ...
    if (ref instanceof HTMLElement) {
      if (properties.isOpen()) {
        ...
        ref.addEventListener("keydown", onKeyDown);
        ref.addEventListener("focusout", onBlur);
        (0, import_solid_js113.onCleanup)(() => {
          ref.removeEventListener("keydown", onKeyDown);
          ref.removeEventListener("focusout", onBlur);
        });
      }
  ...
  return createUnmountable(props, () => properties.isOpen(), () => createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js113.mergeProps)((0, import_solid_use68.omitProps)(props, [
    "as",
    "unmount",
    "children",
    "ref"
...
var RadioGroupContext = (0, import_solid_js114.createContext)();
function useRadioGroupContext(componentName) {
  const context = (0, import_solid_js114.useContext)(RadioGroupContext);
  if (context) {
    return context;
  }
...
var RadioGroupRootContext = (0, import_solid_js115.createContext)();
function useRadioGroupRootContext(componentName) {
  const context = (0, import_solid_js115.useContext)(RadioGroupRootContext);
  if (context) {
    return context;
  }
...
function createRadioGroupOptionFocusNavigator() {
  return new FocusNavigator((0, import_solid_js115.createUniqueId)());
}
...
function RadioGroupControlled(props) {
  ...
  const descriptionID = (0, import_solid_js116.createUniqueId)();
  const labelID = (0, import_solid_js116.createUniqueId)();
      ...
      return (0, import_web3.createComponent)(RadioGroupContext.Provider, {
        ...
        get children() {
          return createDynamic(() => {
            var _a;
            return (_a = props.as) != null ? _a : "div";
          }, (0, import_solid_js116.mergeProps)((0, import_solid_use69.omitProps)(props, [
            "as",
            "children",
            "value",
            "disabled",
...
function RadioGroupUncontrolled(props) {
  const controller = createRadioGroupOptionFocusNavigator();
  const descriptionID = (0, import_solid_js117.createUniqueId)();
  const labelID = (0, import_solid_js117.createUniqueId)();
      ...
      return (0, import_web4.createComponent)(RadioGroupContext.Provider, {
        ...
        get children() {
          return createDynamic(() => {
            var _a;
            return (_a = props.as) != null ? _a : "div";
          }, (0, import_solid_js117.mergeProps)((0, import_solid_use70.omitProps)(props, [
            "as",
            "children",
            "defaultValue",
            "disabled",
...
function RadioGroup(props) {
  if (isRadioGroupUncontrolled(props)) {
    return (0, import_solid_js118.createComponent)(RadioGroupUncontrolled, props);
  }
  return (0, import_solid_js118.createComponent)(RadioGroupControlled, props);
}
...
function RadioGroupDescription(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "div";
  }, (0, import_solid_js119.mergeProps)((0, import_solid_use71.omitProps)(props, ["as"]), RADIO_GROUP_DESCRIPTION_TAG, {
    id: context.descriptionID
  }));
}
...
function RadioGroupLabel(props) {
  ...
  return createDynamic(() => {
    var _a;
    return (_a = props.as) != null ? _a : "label";
  }, (0, import_solid_js120.mergeProps)((0, import_solid_use72.omitProps)(props, ["as"]), RADIO_GROUP_LABEL_TAG, {
    id: context.labelID
  }));
}
...
function RadioGroupOption(props) {
  ...
  return (0, import_solid_js121.createComponent)(RadioGroupContext.Provider, {
    value: { descriptionID, labelID },
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "div";
      }, (0, import_solid_js121.mergeProps)((0, import_solid_use73.omitProps)(props, [
        "as",
        "children",
        "value",
        "disabled",
...
var SelectContext = (0, import_solid_js122.createContext)();
function useSelectContext(componentName) {
  const context = (0, import_solid_js122.useContext)(SelectContext);
  if (context) {
    return context;
  }
...
function createSelectOptionFocusNavigator() {
  return new FocusNavigator((0, import_solid_js122.createUniqueId)());
}
...
function SelectMultipleControlled(props) {
  ...
  return (0, import_solid_js123.createComponent)(SelectContext.Provider, {
    value: {
      controller,
      get horizontal() {
        return !!props.horizontal;
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "ul";
      }, (0, import_solid_js123.mergeProps)((0, import_solid_use74.omitProps)(props, [
        "as",
        "children",
        "toggleable",
        "value",
        ...
        get children() {
          return (0, import_solid_js123.createComponent)(HeadlessSelectRoot, {
            multiple: true,
            onChange: props.onChange,
            get value() {
              return props.value;
...
function SelectMultipleUncontrolled(props) {
  const controller = createSelectOptionFocusNavigator();
  return (0, import_solid_js124.createComponent)(SelectContext.Provider, {
    value: {
      controller,
      get horizontal() {
        return !!props.horizontal;
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "ul";
      }, (0, import_solid_js124.mergeProps)((0, import_solid_use75.omitProps)(props, [
        "as",
        "children",
        "toggleable",
        "defaultValue",
        ...
        get children() {
          return (0, import_solid_js124.createComponent)(HeadlessSelectRoot, {
            multiple: true,
            onChange: props.onChange,
            get defaultValue() {
              return props.defaultValue;
...
function SelectSingleControlled(props) {
  const controller = createSelectOptionFocusNavigator();
  return (0, import_solid_js125.createComponent)(SelectContext.Provider, {
    value: {
      controller,
      get horizontal() {
        return !!props.horizontal;
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "ul";
      }, (0, import_solid_js125.mergeProps)((0, import_solid_use76.omitProps)(props, [
        "as",
        "children",
        "toggleable",
        "value",
        ...
        get children() {
          return (0, import_solid_js125.createComponent)(HeadlessSelectRoot, {
            onChange: props.onChange,
            get value() {
              return props.value;
            },
...
function SelectSingleUncontrolled(props) {
  const controller = createSelectOptionFocusNavigator();
  return (0, import_solid_js126.createComponent)(SelectContext.Provider, {
    value: {
      controller,
      get horizontal() {
        return !!props.horizontal;
    ...
    get children() {
      return createDynamic(() => {
        var _a;
        return (_a = props.as) != null ? _a : "ul";
      }, (0, import_solid_js126.mergeProps)((0, import_solid_use77.omitProps)(props, [
        "as",
        "children",
        "toggleable",
        "defaultValue",
        ...
        get children() {
          return (0, import_solid_js126.createComponent)(HeadlessSelectRoot, {
            onChange: props.onChange,
            get defaultValue() {
              return props.defaultValue;
            },
...
function Select(props) {
  if (isSelectUncontrolled(props)) {
    if (isSelectMultiple(props)) {
      return (0, import_solid_js127.createComponent)(SelectMultipleUncontrolled, props);
    }
    return (0, import_solid_js127.createComponent)(SelectSingleUncontrolled, props);
  }
  if (isSelectMultiple(props)) {
    return (0, import_solid_js127.createComponent)(SelectMultipleControlled, props);
  }
  return (0, import_solid_js127.createComponent)(SelectSingleControlled, props);
}
...
function SelectOption(props) {
  ...
  const properties = useHeadlessSelectProperties();
  const [internalRef, setInternalRef] = (0, import_solid_js128.createSignal)();
  let characters = "";
  let timeout;
  (0, import_solid_js128.onCleanup)(() => {
    if (timeout) {
      clearTimeout(timeout);
    }
  });
  (0, import_solid_js128.createEffect)(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const onKeyDown = (e) => {
        if (!(properties.disabled() || props.disabled)) {
  ...
  return (0, import_solid_js128.createComponent)(Button, (0, import_solid_js128.mergeProps)({
    get as() {
      var _a;
      return (_a = props.as) != null ? _a : "li";
    }
