...
var HeadlessInputContext = createContext5();
function useHeadlessInputProperties() {
  const properties = useContext5(HeadlessInputContext);
  if (properties) {
    return properties;
  }
...
function useHeadlessInput(options) {
  ...
  let setSignal;
  if ("defaultValue" in options) {
    const [input, setInput] = createSignal5(options.defaultValue);
    signal = input;
    setSignal = (value) => {
      batch5(() => {
        var _a;
...
function HeadlessInputRoot(props) {
  ...
  return createComponent7(HeadlessInputContext.Provider, {
    value: properties,
    get children() {
      return createMemo9(() => {
        const body = props.children;
...
var HeadlessAutocompleteContext = createContext6();
function useHeadlessAutocompleteProperties() {
  const properties = useContext6(HeadlessAutocompleteContext);
  if (properties) {
    return properties;
  }
...
function createHeadlessAutocompleteChild(props) {
  return {
    get children() {
      return createComponent8(HeadlessAutocompleteChild, {
        get children() {
          return props.children;
        }
      });
...
var HeadlessAutocompleteOptionContext = createContext7();
function useHeadlessAutocompleteOptionProperties() {
  const properties = useContext7(HeadlessAutocompleteOptionContext);
  if (properties) {
    return properties;
  }
...
function HeadlessAutocompleteOption(props) {
  ...
  return createComponent9(HeadlessAutocompleteOptionContext.Provider, {
    value: properties,
    get children() {
      return createMemo11(() => {
        const body = props.children;
...
function createHeadlessAutocompleteOptionProps(props) {
  return {
    get children() {
      return createComponent9(HeadlessAutocompleteOption, {
        get value() {
          return props.value;
        },
        get disabled() {
...
function createHeadlessAutocompleteOptionChildProps(props) {
  return {
    get children() {
      return createComponent9(HeadlessAutocompleteOptionChild, {
        get children() {
          return props.children;
        }
      });
...
function useHeadlessAutocomplete(options) {
  const [active, setActive] = createSignal6();
  let signal;
  let setSignal;
  if ("defaultValue" in options) {
    const [input, setInput] = createSignal6(options.defaultValue);
    signal = input;
    setSignal = (value) => {
      batch6(() => {
        var _a;
  ...
  return {
    ...
    setValue(value) {
      if (options.toggleable && Object.is(untrack3(signal), value)) {
        setSignal(void 0);
      } else {
        setSignal(value);
      }
...
function HeadlessAutocompleteRoot(props) {
  ...
  return createComponent10(HeadlessAutocompleteContext.Provider, {
    value: properties,
    get children() {
      return createMemo12(() => {
        const body = props.children;
...
function createHeadlessAutocompleteRootControlledProps(props) {
  return {
    get children() {
      return createComponent10(HeadlessAutocompleteRoot, {
        onChange: props.onChange,
        get value() {
          return props.value;
        },
...
function createDynamic(source, props) {
  return createComponent11(Dynamic, mergeProps({
    get component() {
      return source();
    }
  }, props));
...
// src/components/accordion/AccordionContext.ts
var AccordionContext = createContext8();
function useAccordionContext(componentName) {
  const context = useContext8(AccordionContext);
  if (context) {
    return context;
  }
...
function AccordionMultipleControlled(props) {
  ...
  return createComponent12(AccordionContext.Provider, {
    value: controller,
    get children() {
...
function AccordionMultipleUncontrolled(props) {
  const controller = createAccordionFocusNavigator();
  return createComponent13(AccordionContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(
        () => {
...
function AccordionSingleControlled(props) {
  const controller = createAccordionFocusNavigator();
  return createComponent14(AccordionContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(
        () => {
...
function AccordionSingleUncontrolled(props) {
  const controller = createAccordionFocusNavigator();
  return createComponent15(AccordionContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(
        () => {
...
function Accordion(props) {
  if (isAccordionUncontrolled(props)) {
    if (isAccordionMultiple(props)) {
      return createComponent16(AccordionMultipleUncontrolled, props);
    }
    return createComponent16(AccordionSingleUncontrolled, props);
  }
  if (isAccordionMultiple(props)) {
    return createComponent16(AccordionMultipleControlled, props);
  }
  return createComponent16(AccordionSingleControlled, props);
}
...
var AccordionItemContext = createContext9();
function useAccordionItemContext(componentName) {
  const context = useContext9(AccordionItemContext);
  if (context) {
    return context;
  }
...
function AccordionItem(props) {
  ...
  return createComponent17(AccordionItemContext.Provider, {
...
function AccordionButton(props) {
  ...
  return createComponent18(Button, mergeProps9(
    omitProps8(props, ["children", "ref", "disabled"]),
...
var AlertDialogContext = createContext10();
function useAlertDialogContext(componentName) {
  const context = useContext10(AlertDialogContext);
  if (context) {
    return context;
  }
...
function AlertDialogControlled(props) {
  ...
  return createComponent20(AlertDialogContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return createComponent20(HeadlessDisclosureRoot, {
        get isOpen() {
          return props.isOpen;
        },
        get disabled() {
...
function AlertDialogUncontrolled(props) {
  ...
  const fsp = useFocusStartPoint();
  return createComponent21(AlertDialogContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return createComponent21(HeadlessDisclosureRoot, {
        get defaultOpen() {
...
function AlertDialog(props) {
  if (isAlertDialogUncontrolled(props)) {
    return createComponent22(AlertDialogUncontrolled, props);
  }
  return createComponent22(AlertDialogControlled, props);
}
...
function Fragment(props) {
  return createMemo13(() => props.children);
}
...
var CheckboxContext = createContext11();
function useCheckboxContext(componentName) {
  const context = useContext11(CheckboxContext);
  if (context) {
    return context;
  }
...
function CheckboxControlled(props) {
  ...
  return createComponent23(CheckboxContext.Provider, {
    value: {
      ownerID,
      labelID,
      indicatorID,
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps18(
          ...
          {
            get children() {
              return createComponent23(HeadlessToggleRoot, {
                onChange: props.onChange,
                get checked() {
...
function CheckboxUncontrolled(props) {
  ...
  return createComponent24(CheckboxContext.Provider, {
    value: {
      ownerID,
      labelID,
      indicatorID,
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps19(
          ...
          {
            get children() {
              return createComponent24(HeadlessToggleRoot, {
                onChange: props.onChange,
                get checked() {
                  return props.checked;
                },
...
function Checkbox(props) {
  if (isCheckboxUncontrolled(props)) {
    return createComponent25(CheckboxUncontrolled, props);
  }
  return createComponent25(CheckboxControlled, props);
}
...
function CheckboxIndicator(props) {
  ...
  return createComponent26(Button, mergeProps21(
    omitProps20(props, [
      "children",
      "ref"
    ]),
    ...
    {
      get children() {
        return createComponent26(HeadlessToggleChild, {
          get children() {
            return props.children;
          }
        });
...
var ColorSchemeContext = createContext12();
var STORAGE_KEY = "theme-preference";
function ColorSchemeProvider(props) {
  let get;
  let set;
  if ("initialValue" in props) {
    const [scheme, setScheme] = createSignal12(props.initialValue);
    get = scheme;
    set = (value) => {
      var _a;
      setScheme(value);
  ...
  const shouldToggle = createMemo14(() => get() === "system" && prefersDark() || get() === "dark");
  createEffect6(() => {
    isVisible();
    const onChange = () => {
  ...
  return createComponent27(ColorSchemeContext.Provider, {
    value: {
      get value() {
        return get();
      },
...
function useColorSchemeContext() {
  const ctx = useContext12(ColorSchemeContext);
  if (ctx) {
    return ctx;
  }
...
var CommandBarContext = createContext13();
function useCommandBarContext(componentName) {
  const context = useContext13(CommandBarContext);
  if (context) {
    return context;
  }
...
function CommandBarEvents(props) {
  ...
  return createMemo15(() => props.children);
}
...
function CommandBarControlled(props) {
  ...
  const fsp = useFocusStartPoint();
  return createComponent28(CommandBarContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return createComponent28(HeadlessDisclosureRoot, {
        ...
        children: ({ isOpen }) => createComponent28(CommandBarEvents, {
          get children() {
            return createUnmountable(
              props,
              isOpen,
  ...
  return createComponent29(CommandBarContext.Provider, {
    ...
    get children() {
      return createComponent29(HeadlessDisclosureRoot, {
        ...
        children: ({ isOpen }) => createComponent29(CommandBarEvents, {
          get children() {
            return createUnmountable(
              props,
              isOpen,
...
function CommandBar(props) {
  if (isCommandBarUncontrolled(props)) {
    return createComponent30(CommandBarUncontrolled, props);
  }
  return createComponent30(CommandBarControlled, props);
}
...
var ContextMenuContext = createContext14();
function useContextMenuContext(componentName) {
  const context = useContext14(ContextMenuContext);
  if (context) {
    return context;
  }
...
function ContextMenuControlled(props) {
  ...
  const fsp = useFocusStartPoint();
  return createComponent31(ContextMenuContext.Provider, {
    value: {
      ownerID,
      boundaryID,
      panelID
...
function ContextMenuUncontrolled(props) {
  ...
  const fsp = useFocusStartPoint();
  return createComponent32(ContextMenuContext.Provider, {
    value: {
      ownerID,
      boundaryID,
      panelID
...
function ContextMenu(props) {
  if (isContextMenuUncontrolled(props)) {
    return createComponent33(ContextMenuUncontrolled, props);
  }
  return createComponent33(ContextMenuControlled, props);
}
...
var DialogContext = createContext15();
function useDialogContext(componentName) {
  const context = useContext15(DialogContext);
  if (context) {
    return context;
  }
...
function DialogControlled(props) {
  ...
  const fsp = useFocusStartPoint();
  return createComponent34(DialogContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
...
function DialogUncontrolled(props) {
  ...
  const fsp = useFocusStartPoint();
  return createComponent35(DialogContext.Provider, {
    value: {
      ownerID,
      panelID,
      titleID,
    ...
    get children() {
      return createComponent35(HeadlessDisclosureRoot, {
        get defaultOpen() {
          return props.defaultOpen;
        },
        get disabled() {
...
function Dialog(props) {
  if (isDialogUncontrolled(props)) {
    return createComponent36(DialogUncontrolled, props);
  }
  return createComponent36(DialogControlled, props);
}
...
var DisclosureContext = createContext16();
function useDisclosureContext(componentName) {
  const context = useContext16(DisclosureContext);
  if (context) {
    return context;
  }
...
function DisclosureControlled(props) {
  ...
  return createComponent37(DisclosureContext.Provider, {
    value: {
      ownerID,
      buttonID,
      panelID
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps40(
          ...
          {
            get children() {
              return createComponent37(HeadlessDisclosureRoot, {
                get isOpen() {
                  return props.isOpen;
                },
                get disabled() {
...
function DisclosureUncontrolled(props) {
  ...
  return createComponent38(DisclosureContext.Provider, {
    value: {
      ownerID,
      buttonID,
      panelID
...
function Disclosure(props) {
  if (isDisclosureUncontrolled(props)) {
    return createComponent39(DisclosureUncontrolled, props);
  }
  return createComponent39(DisclosureControlled, props);
}
...
function DisclosureButton(props) {
  ...
  return createComponent40(Button, mergeProps42(
    omitProps41(props, [
      "children",
      "ref"
    ]),
...
var FeedContext = createContext17();
function useFeedContext(componentName) {
  const context = useContext17(FeedContext);
  if (context) {
    return context;
  }
...
function Feed(props) {
  ...
  let internalRef;
  return createComponent41(FeedContext.Provider, {
    value: {
      ownerID,
      labelID,
      contentID,
...
var FeedArticleContext = createContext18();
function useFeedArticleContext(componentName) {
  const context = useContext18(FeedArticleContext);
  if (context) {
    return context;
  }
...
var FeedContentContext = createContext19();
function useFeedContentContext(componentName) {
  const context = useContext19(FeedContentContext);
  if (context) {
    return context;
  }
...
function FeedArticle(props) {
  ...
  const [internalRef, setInternalRef] = createSignal21();
  createEffect16(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const onKeyDown = (e) => {
  ...
  return createComponent42(FeedArticleContext.Provider, {
    value: {
      ownerID,
      labelID,
      descriptionID
...
function FeedContent(props) {
  ...
  const [internalRef, setInternalRef] = createSignal22();
  createEffect17(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const onKeyDown = (e) => {
  ...
  return createComponent43(FeedContentContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(
        () => {
...
var ListboxContext = createContext20();
function useListboxContext(componentName) {
  const context = useContext20(ListboxContext);
  if (context) {
    return context;
  }
...
function ListboxSCSCD(props) {
  ...
  const fsp = useFocusStartPoint();
  return createComponent48(ListboxContext.Provider, {
    value: {
      multiple: false,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps54(
          ...
          {
            get children() {
              return createComponent48(HeadlessSelectRoot, {
                onChange: props.onSelectChange,
                get toggleable() {
                  return props.toggleable;
                },
                ...
                get children() {
                  return createComponent48(HeadlessDisclosureRoot, {
                    onChange(value) {
                      var _a;
                      if (value) {
                        fsp.save();
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps55(
          ...
          {
            get children() {
              return createComponent49(HeadlessSelectRoot, {
                onChange: props.onSelectChange,
                get toggleable() {
                  return props.toggleable;
                },
                ...
                get children() {
                  return createComponent49(HeadlessDisclosureRoot, {
                    onChange(value) {
                      var _a;
                      if (value) {
                        fsp.save();
...
function ListboxSUSCD(props) {
  const [hovering, setHovering] = createSignal29(false);
  ...
  const fsp = useFocusStartPoint();
  return createComponent50(ListboxContext.Provider, {
    value: {
      multiple: false,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps56(
          ...
          {
            get children() {
              return createComponent50(HeadlessSelectRoot, {
                onChange: props.onSelectChange,
                get toggleable() {
                  return props.toggleable;
                },
                ...
                get children() {
                  return createComponent50(HeadlessDisclosureRoot, {
                    onChange(value) {
                      var _a;
                      if (value) {
                        fsp.save();
...
function ListboxSUSUD(props) {
  const [hovering, setHovering] = createSignal30(false);
  ...
  const fsp = useFocusStartPoint();
  return createComponent51(ListboxContext.Provider, {
    value: {
      multiple: false,
      ownerID,
      labelID,
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps57(
          ...
          {
            get children() {
              return createComponent51(HeadlessSelectRoot, {
                onChange: props.onSelectChange,
                get toggleable() {
                  return props.toggleable;
                },
                ...
                get children() {
                  return createComponent51(HeadlessDisclosureRoot, {
                    onChange(value) {
                      var _a;
                      if (value) {
                        fsp.save();
  ...
  if (isListboxMultiple(props)) {
    if (isListboxSelectUncontrolled(props)) {
      if (isListboxDisclosureUncontrolled(props)) {
        return createComponent52(ListboxMUSUD, props);
      }
      return createComponent52(ListboxMUSCD, props);
    }
    if (isListboxDisclosureUncontrolled(props)) {
      return createComponent52(ListboxMCSUD, props);
    }
    return createComponent52(ListboxMCSCD, props);
  }
  if (isListboxSelectUncontrolled(props)) {
    if (isListboxDisclosureUncontrolled(props)) {
      return createComponent52(ListboxSUSUD, props);
    }
    return createComponent52(ListboxSUSCD, props);
  }
  if (isListboxDisclosureUncontrolled(props)) {
    return createComponent52(ListboxSCSUD, props);
  }
  return createComponent52(ListboxSCSCD, props);
}
...
function ListboxButton(props) {
  ...
  return createComponent53(Button, mergeProps58(
    omitProps57(props, [
      "children",
      "ref"
    ]),
...
var ListboxOptionsContext = createContext21();
function useListboxOptionsContext(componentName) {
  const context = useContext21(ListboxOptionsContext);
  if (context) {
    return context;
  }
...
function ListboxOption(props) {
  ...
  return createComponent54(Button, mergeProps60(
    omitProps59(props, [
      "as",
      "children",
      "value",
...
function ListboxOptions(props) {
  ...
  const properties = useHeadlessDisclosureProperties();
  const [internalRef, setInternalRef] = createSignal33();
  ...
  return createComponent55(ListboxOptionsContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(
        () => {
...
var MenuContext = createContext22();
function useMenuContext(componentName) {
  const context = useContext22(MenuContext);
  if (context) {
    return context;
  }
...
function Menu(props) {
  ...
  return createComponent56(MenuContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(
        () => {
...
function MenuItem(props) {
  ...
  const [internalRef, setInternalRef] = createSignal34();
  let characters = "";
  let timeout;
  onCleanup22(() => {
    if (timeout) {
  ...
  return createDynamic(
    ...
    mergeProps63(
      ...
      {
        get children() {
          return createComponent57(MenuChild, {
            get disabled() {
              return props.disabled;
            },
            get children() {
...
var PopoverContext = createContext23();
function usePopoverContext(componentName) {
  const context = useContext23(PopoverContext);
  if (context) {
    return context;
  }
...
function PopoverControlled(props) {
  const [hovering, setHovering] = createSignal35(false);
  const ownerID = createUniqueId27();
  const buttonID = createUniqueId27();
  const panelID = createUniqueId27();
  const fsp = useFocusStartPoint();
  return createComponent58(PopoverContext.Provider, {
    value: {
      ownerID,
      buttonID,
      panelID,
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps64(
          ...
          {
            get children() {
              return createComponent58(HeadlessDisclosureRoot, {
                get isOpen() {
                  return props.isOpen;
                },
                get disabled() {
...
function PopoverUncontrolled(props) {
  const [hovering, setHovering] = createSignal36(false);
  const ownerID = createUniqueId28();
  const buttonID = createUniqueId28();
  const panelID = createUniqueId28();
  const fsp = useFocusStartPoint();
  return createComponent59(PopoverContext.Provider, {
    value: {
      ownerID,
      buttonID,
      panelID,
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps65(
          ...
          {
            get children() {
              return createComponent59(HeadlessDisclosureRoot, {
                get defaultOpen() {
                  return props.defaultOpen;
                },
                get disabled() {
...
function Popover(props) {
  if (isPopoverUncontrolled(props)) {
    return createComponent60(PopoverUncontrolled, props);
  }
  return createComponent60(PopoverControlled, props);
}
...
function PopoverButton(props) {
  ...
  return createComponent61(Button, mergeProps66(
    omitProps65(props, [
      "children",
      "ref"
    ]),
...
var RadioGroupContext = createContext24();
function useRadioGroupContext(componentName) {
  const context = useContext24(RadioGroupContext);
  if (context) {
    return context;
  }
...
var RadioGroupRootContext = createContext25();
function useRadioGroupRootContext(componentName) {
  const context = useContext25(RadioGroupRootContext);
  if (context) {
    return context;
  }
...
function RadioGroupControlled(props) {
  ...
  return createComponent62(RadioGroupRootContext.Provider, {
    value: controller,
    get children() {
      return createComponent62(RadioGroupContext.Provider, {
        value: {
          descriptionID,
          labelID
        },
...
function RadioGroupUncontrolled(props) {
  ...
  return createComponent63(RadioGroupRootContext.Provider, {
    value: controller,
    get children() {
      return createComponent63(RadioGroupContext.Provider, {
        value: {
          descriptionID,
          labelID
        },
...
function RadioGroup(props) {
  if (isRadioGroupUncontrolled(props)) {
    return createComponent64(RadioGroupUncontrolled, props);
  }
  return createComponent64(RadioGroupControlled, props);
}
...
function RadioGroupOption(props) {
  ...
  return createComponent65(RadioGroupContext.Provider, {
...
var SelectContext = createContext26();
function useSelectContext(componentName) {
  const context = useContext26(SelectContext);
  if (context) {
    return context;
  }
...
function SelectMultipleControlled(props) {
  ...
  return createComponent66(SelectContext.Provider, {
    value: {
      controller,
      get horizontal() {
        return !!props.horizontal;
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps74(
          ...
          {
            get children() {
              return createComponent66(HeadlessSelectRoot, {
                multiple: true,
                onChange: props.onChange,
                get value() {
                  return props.value;
...
function SelectMultipleUncontrolled(props) {
  const controller = createSelectOptionFocusNavigator();
  return createComponent67(SelectContext.Provider, {
    value: {
      controller,
      get horizontal() {
        return !!props.horizontal;
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps75(
          ...
          {
            get children() {
              return createComponent67(HeadlessSelectRoot, {
                multiple: true,
                onChange: props.onChange,
                get defaultValue() {
                  return props.defaultValue;
...
function SelectSingleControlled(props) {
  const controller = createSelectOptionFocusNavigator();
  return createComponent68(SelectContext.Provider, {
    value: {
      controller,
      get horizontal() {
        return !!props.horizontal;
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps76(
          ...
          {
            get children() {
              return createComponent68(HeadlessSelectRoot, {
                onChange: props.onChange,
                get value() {
                  return props.value;
                },
...
function SelectSingleUncontrolled(props) {
  const controller = createSelectOptionFocusNavigator();
  return createComponent69(SelectContext.Provider, {
    value: {
      controller,
      get horizontal() {
        return !!props.horizontal;
    ...
    get children() {
      return createDynamic(
        ...
        mergeProps77(
          ...
          {
            get children() {
              return createComponent69(HeadlessSelectRoot, {
                onChange: props.onChange,
                get defaultValue() {
                  return props.defaultValue;
                },
...
function Select(props) {
  if (isSelectUncontrolled(props)) {
    if (isSelectMultiple(props)) {
      return createComponent70(SelectMultipleUncontrolled, props);
    }
    return createComponent70(SelectSingleUncontrolled, props);
  }
  if (isSelectMultiple(props)) {
    return createComponent70(SelectMultipleControlled, props);
  }
  return createComponent70(SelectSingleControlled, props);
}
...
function SelectOption(props) {
  ...
  return createComponent71(Button, mergeProps78(
    {
      get as() {
        var _a;
        return (_a = props.as) != null ? _a : "li";
...
var TabGroupContext = createContext27();
function useTabGroupContext(componentName) {
  const context = useContext27(TabGroupContext);
  if (context) {
    return context;
  }
...
var TabListContext = createContext28();
function useTabListContext(componentName) {
  const context = useContext28(TabListContext);
  if (context) {
    return context;
  }
...
function TabGroupControlled(props) {
  ...
  return createComponent72(TabGroupContext.Provider, {
    value: {
      get horizontal() {
        var _a;
...
function TabGroupUncontrolled(props) {
  ...
  let id = 0;
  const ids = /* @__PURE__ */ new Map();
  return createComponent73(TabGroupContext.Provider, {
    value: {
      get horizontal() {
        var _a;
        return (_a = props.horizontal) != null ? _a : true;
...
function TabGroup(props) {
  if (isTabGroupUncontrolled(props)) {
    return createComponent74(TabGroupUncontrolled, props);
  }
  return createComponent74(TabGroupControlled, props);
}
...
function TabList(props) {
  ...
  return createComponent75(TabListContext.Provider, {
    value: controller,
    get children() {
      return createDynamic(
        () => {
        ...
        mergeProps82(
          omitProps81(props, ["as", "ref", "children"]),
          TAB_LIST_TAG,
          {
            role: "tablist",
            get "aria-orientation"() {
...
function TabPanel(props) {
  ...
  return createUnmountable(
    ...
    () => createDynamic(
      ...
      mergeProps83(
        omitProps82(props, ["as", "children", "disabled", "unmount", "value"]),
        TAB_PANEL_TAG,
        {
          role: "tabpanel",
          get tabindex() {
...
var ToastContext = createContext29();
function useToastContext(componentName) {
  const context = useContext29(ToastContext);
  if (context) {
    return context;
  }
...
function Toaster(props) {
  ...
  return createComponent76(ToastContext.Provider, {
    value: {
      ownerID
    },
    get children() {
...
function useToaster(toaster) {
  const [signal, setSignal] = createSignal43(toaster.getQueue());
  createEffect28(() => {
...
import {
  createComponent as createComponent79
} from "solid-js";
...
import {
  ...
  createComponent as createComponent77,
...
function ToggleControlled(props) {
  ...
  return createComponent77(Button, mergeProps86(
    omitProps85(props, [
      "onChange",
      "pressed",
      "ref"
...
import {
  ...
  createComponent as createComponent78,
...
function ToggleUncontrolled(props) {
  const [state, setState] = createSignal45(!!props.defaultPressed);
  const [internalRef, setInternalRef] = createSignal45();
  createEffect30(() => {
    const ref = internalRef();
    if (ref instanceof HTMLElement) {
      const onClick = () => {
  ...
  return createComponent78(Button, mergeProps87(
    omitProps86(props, [
      "onChange",
      "defaultPressed",
      "ref"
...
function Toggle(props) {
  if (isToggleUncontrolled(props)) {
    return createComponent79(ToggleUncontrolled, props);
  }
  return createComponent79(ToggleControlled, props);
}

// src/components/toolbar/index.ts
import {
  createEffect as createEffect31,
  createSignal as createSignal46,
...
function Toolbar(props) {
  ...
  const [internalRef, setInternalRef] = createSignal46();
  let focusedElement;
...
import {
  createComponent as createComponent80,
  createContext as createContext30,
  createEffect as createEffect32,
  createSignal as createSignal47,
...
function Transition(props) {
  ...
  return createComponent80(TransitionRootContext.Provider, {
    value: local,
    get children() {
      return createComponent80(TransitionChild, others);
    }
  });
}
export {
  ...
  FeedContent,
  FeedLabel,
  HeadlessAutocompleteChild,
  HeadlessAutocompleteContext,
  HeadlessAutocompleteOption,
  HeadlessAutocompleteOptionChild,
  HeadlessAutocompleteOptionContext,
  HeadlessAutocompleteRoot,
  ...
  Transition,
  TransitionChild,
  createHeadlessAutocompleteChild,
  createHeadlessAutocompleteOptionChildProps,
  createHeadlessAutocompleteOptionProps,
  createHeadlessAutocompleteRootControlledProps,
  createHeadlessAutocompleteRootUncontrolledProps,
